...
public class QiniuCloudUtil {
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "LftSeXD3ry8X3qeHsIDgObgjAvYze7cYOXbNdhNk";
    private static final String SECRET_KEY = "jxQeG8Oo_7s2p8TzTeR_ENKXwR-TfrrPUj2Tsgof";

    // 要上传的空间
    private static final String bucketname = "caofeifan";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "pxhoarrxt.bkt.clouddn.com";
